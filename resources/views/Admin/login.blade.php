...
<div class="loginWraper">
	<div id="loginform" class="loginBox">
		...
		<form class="form form-horizontal" action="" method="post" id="form-account-password">
			{{ csrf_field() }}
			<div class="row cl">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					<label for="online">
						<input type="checkbox" name="keep" id="keep" value="1" @if(session('checked') == "1")checked="checked"@endif>
						使我保持登录状态
					</label>
				</div>
			</div>
