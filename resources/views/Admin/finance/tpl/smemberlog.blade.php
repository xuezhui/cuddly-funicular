...
<section class="">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
        <span class="c-gray en">&gt;</span> 服务商提现申请 <span class="c-gray en">&gt;</span> 服务商账单列表
    </nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			<form class="text-c" action="/admin/finance/log" method="post"> 日期范围：
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<span class="r">共有数据：<strong>{{$records->total()}}</strong> 条</span>
			</div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					@foreach($records as $log)
						<tr class="text-c">
							<td>{{$log->id}}</td>
							<td>{{$log->member->nickname}}</td>
							<td>{{$log->member->telephone}}</td>
							<td>
