...
<div class="row cl">
	...
	<div class="formControls col-xs-8 col-sm-9">
		<input type="text" class="input-text" value="@if($activity){{$activity->name}}@endif" placeholder="" id="name" name="name">
	</div>
</div>
...
<div class="row cl">
	...
	<div class="formControls col-xs-8 col-sm-9 skin-minimal">
		<div class="radio-box">
			<input name="isable" type="radio" id="sex-1" @if(!$activity||!$activity->isable)checked @endif value="0">
			<label for="sex-1">未上架</label>
		</div>
		<div class="radio-box">
			<input type="radio" id="sex-2" name="isable" @if($activity&&$activity->isable)checked @endif value="1">
...
<div class="row cl">
	...
	<div class="formControls col-xs-8 col-sm-9">
		<div class="uploader-thum-container">
			<input name="photos" class="input-text" id="photos" value="@if($activity){{$activity->photos}}@endif" readonly>
			<span class="choose">
			...
			<img src="@if($activity){{$activity->photos}}@endif" alt="" id="img" class="img-thumbnail">
		</div>
	</div>
</div>
<div class="row cl">
	...
	<div class="formControls col-xs-8 col-sm-9">
		<div class="uploader-list-container">
			<div class="queueList " >
				<div id="dndArea" class="placeholder @if($activity&&$activity->description&&count($activity->description)>0)element-invisible @endif">
					<div id="filePicker-2"></div>
					<p>或将照片拖到这里</p>
				</div>
				@if($activity&&$activity->description&&count($activity->description)>0)
					<ul class="filelist">
						@foreach($activity->description as $img)
							<li id="">
								<p class="title"></p>
								<p class="imgWrap">
									<img src="{{$img}}">
			...
			<div class="statusBar" @if(!$activity || count($activity->description)<1)style="display:none;" @endif>
